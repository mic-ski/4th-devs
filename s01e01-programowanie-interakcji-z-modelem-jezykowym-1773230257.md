...
Cześć! Miło mi powitać Cię w AI\_devs 4: Builders. To szkolenie, w którym poprzez budowanie gotowych produkcyjnie rozwiązań przekonamy się, co może, a czego nie może generatywna sztuczna inteligencja.
...
Kod źródłowy dla powyższej interakcji dostępny jest w przykładzie [01\_01\_interaction](https://github.com/i-am-alice/4th-devs/tree/main/01_01_interaction).
...
Przykład kodu przedstawiający pracę z **Structured Outputs** znajduje się w [01\_01\_structured](https://github.com/i-am-alice/4th-devs/tree/main/01_01_structured).
...
Przy wyborze modeli, warto zadbać o fundamenty w postaci systemu, który pozwoli pozostać nam na bieżąco z najnowszymi premierami i można to zrobić na przynajmniej kilka sposobów. Jednym z nich jest zaobserwowanie w mediach społecznościowych (szczególnie X oraz LinkedIn) kont firm: [OpenAI](https://openai.com/), [Anthropic](https://anthropic.com/), [DeepMind](https://deepmind.google/), [xAI](https://x.ai/) oraz w kontekście modeli otwartych [DeepSeek](https://www.deepseek.com/), [Z.ai](https://z.ai), [Qwen](https://qwen.ai/), [Bytedance](https://seed.bytedance.com/en/direction/llm), [Kimi](https://www.kimi.com/en), [Black Forest Labs](https://bfl.ai/), [Kling](https://klingai.com/global/) oraz oczywiście [Hugging Face](https://huggingface.co). Poza firmami warto obserwować także profile, newslettery oraz blogi ich pracowników, a także osoby które oni obserwują. Dobrym pomysłem jest dodanie do tej listy narzędzi (np. [LM Studio](lmstudio.ai)) oraz twórców narzędzi, które będziemy omawiać podczas AI\_devs.
...
Aby się o tym przekonać wystarczy spojrzeć na publikowane prompty systemowe narzędzi takich jak [Claude](https://code.claude.com/) czy [Grok](https://github.com/xai-org/grok-prompts/tree/main) oraz te będące wynikiem pracy osoby działającej pod nickiem [elder\_plinus](https://github.com/elder-plinius/CL4R1T4S). W jego kontekście warto też zapoznać się z promptami wykorzystywanymi do tzw. jailbreakingu modeli, czyli procesu omijania ograniczeń narzucanych przez twórców. Można je zobaczyć [tutaj](https://github.com/elder-plinius/L1B3RT4S) (uwaga: korzystanie z tych promptów może doprowadzić do zawieszenia konta. Ich treść też niekiedy bywa wulgarna).
...
W praktyce jednak okazuje się, że większość firm decyduje się na pozostanie przy komercyjnych LLM albo poprzez API providerów z którymi będziemy pracować w AI\_devs, albo usługi takie jak Amazon Bedrock czy Microsoft Azure. Natomiast inwestycja w sprzęt do lokalnej inferencji często okazuje się nieuzasadniona.
...
1. Przed wyruszeniem w drogę trzeba zebrać drużynę modeli <https://youtu.be/X2kWqlSnX1E?list=PL6gb3F2o2zOTJYxrcnWphmGLylXIlVCGJ>, <https://arxiv.org/abs/2601.05106>
